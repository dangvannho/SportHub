...
router.post('/owners', middlewareController.verifyTokenAdmin, upload.single('profile_picture'), addOwner);
router.put('/owners/:id', middlewareController.verifyToken, upload.single('profile_picture'), updateOwner);
...
router.post('/users', middlewareController.verifyTokenAdmin, upload.single('profile_picture'), addUser);
router.put('/users/:id', middlewareController.verifyToken, upload.single('profile_picture'), updateUser);
